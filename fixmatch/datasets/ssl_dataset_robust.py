...
mean['torchvision_cifar10'] = mean['cifar10']
...
std['torchvision_cifar10'] = std['cifar10']
...
def get_transform(mean, std, dataset, train=True):
    if dataset in ['cifar10', 'cifar20', 'cifar100', 'torchvision_cifar10']:
        crop_size = 32
...
class SSL_Dataset:
    ...
    def get_data(self):
        ...
        if self.name == "cifar10":
            ...
            data = dset.data
        elif self.name == 'torchvision_cifar10':
            dset = torchvision.datasets.CIFAR10(root=self.data_dir, train=self.train)
            data = dset.data
